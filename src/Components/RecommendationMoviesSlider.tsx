          ...
          <Carousel
                  ...
                  >
                    {results?.slice(0, 10).map(movie => 
                      <Link
                        onClick={scrollTOTop}
                        to={`/movies/${movie.id}/overview`} key={movie.id} className="block h-full bg-white dark:bg-gray-800 rounded-2xl overflow-hidden shadow-md hover:shadow-lg transition duration-300">
                                  <img
